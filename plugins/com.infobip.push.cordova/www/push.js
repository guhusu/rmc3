cordova.define("com.infobip.push.cordova.Push", function(require, exports, module) {var push = {
    /********************************/
    /********** Push Class **********/
    /********************************/        
    ...
    initialize: function(notificationListener) {
        ...
        cordova.exec(
                ...
                [{"notificationListener": "push.push_notificationListenerCallback"}]              // and this array of custom arguments
    ...
    register: function(args) {
        ...
        cordova.exec(
            ...
            errorCallback,      
            'Push',             
            'registerOnPushService',
            [args]              
            ); 
    },
    setUserId: function(userId, successCallback, errorCallback) {
        if (typeof successCallback != "function") {
            console.log("Infobip Push failure: success callback parameter must be a function");
            return
        }
        if (typeof errorCallback != "function")  {
            console.log("Infobip Push failure: errorCallback parameter not a function");
            return
        }
...
registerToChannels: function(args, successCallback, errorCallback) {
    ...
    if (typeof successCallback != "function")  {
        console.log("Infobip Push failure: successCallback parameter not a function");
        return;
    };
    function dummySuccessCallback(){};
...
isRegistered: function(successCallback) {
    ...
    errorCallback = function (){
        console.log("Error occurred while checking whether application is registered!");
    };
...
getRegistrationData: function(registrationDataCallback) {
    if (typeof registrationDataCallback != "function") {
        console.log("Infobip Push failure: registration data callback parameter must be a function");
        return
    }
...
getApplicationData: function(applicationDataCallback) {
    if (typeof applicationDataCallback != "function") {
        console.log("Infobip Push failure: applicationDataCallback parameter must be a function");
        return
    }
...
isLibraryInitialized: function(isInitializeCallback) {
    if (typeof isInitializeCallback != "function") {
        console.log("Infobip Push failure: isInitializeCallback parameter must be a function");
        return
    }
...
isDefaultMessageHandlingOverriden: function(developerHandleMessageCallback) {
    if (typeof developerHandleMessageCallback != "function") {
        console.log("Infobip Push failure: developerHandleMessageCallback parameter must be a function");
        return
    }

    function errorCallback(){
        console.log("Error occurred while checking if default message handling is overriden!");
    };
...
notifyNotificationOpened: function(args) {
    ...
    cordova.exec(
        ...
        [{
            ...
            cancelAllNotifications: function() {
             ...
             function errorCallback(){
                 console.log("Error occurred while canceling all notifications from notification bar!");
             };
    ...
    setTimezoneOffsetAutomaticUpdateEnabled: function(updataEnable) {
        function successCallback(){};
        function errorCallback(){
            console.log("Error occurred while setting timezone offset automatic update!");
        };
    ...
    isMediaNotification:function (notification, successCallback) {
        ...
        errorCallback = function () {
            console.log("Error occurred while checking if notification is a media notification!");
        };
    ...
    getMediaData:function (notification, successCallback, errorCallback) {
        ...
        if (typeof errorCallback != "function") {
            console.log("Infobip Push failure: error callback parameter must be a function");
            return
        }
    ...
    addMediaView:function (notification, customization, errorCallback) {
        ...
        cordova.exec(
            ...
            'addMediaView',
            [
            {"notification": notification,"customization": customization }
            ]
            );
    },
    ...
    setBackgroundLocationUpdateModeEnabled: function(backgroundLocation) {
        function successCallback(){};
        function errorCallback(){
            console.log("Error occurred while setting background location update mode!");
        };
    ...
    backgroundLocationUpdateModeEnabled: function(successCallback) {
        ...
        errorCallback = function (){
            console.log("Error occurred while checking if backgroud location update mode is enabled!");
        };
